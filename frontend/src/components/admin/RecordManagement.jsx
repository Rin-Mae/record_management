...
const RECORD_TYPE_CONFIG = {
  ...
  "enrollment-list": { label: "Enrollment List", short: "Enrollment List" },
};
...
export default function RecordManagement() {
  ...
  const fetchRecords = useCallback(
    ...
    [recordType, search, pagination.perPage],
  );
  ...
  // Search students for the student selector
  useEffect(() => {
    ...
    <>
      ...
      <div className="admin-main-content min-vh-100 bg-light">
        ...
        <div className="d-lg-none bg-dark text-white p-3 d-flex align-items-center">
          ...
          <span className="fw-semibold">{typeConfig.label}</span>
        </div>
        ...
        <div className="container-fluid p-4">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
              <h1 className="h3 mb-1">{typeConfig.label}</h1>
              <p className="text-muted mb-0">
                Manage {typeConfig.short.toLowerCase()} records across all
                students
              </p>
            </div>
            <button
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  {modalMode === "create" ? "Add" : "Edit"} {typeConfig.short}{" "}
                  Record
                </h5>
                <button
                  type="button"
              ...
              <div className="modal-body">
                <div className="row g-3">
                  <div className="col-12">
                    <span className="badge bg-success">{typeConfig.short}</span>
                  </div>
